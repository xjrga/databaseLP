...
CALL LP1.addCoefficient(.002);
CALL LP1.addCoefficient(.004);
CALL LP1.addLinearObjectiveFunction(0);
--
CALL LP1.addCoefficientSpace(1);
CALL LP1.setCoefficientSpace(1);
CALL LP1.addCoefficient(.09);
CALL LP1.addCoefficient(.04);
CALL  LP1.addLinearConstraint(1, v_geq, v_constraint0_value);
--
CALL LP1.addCoefficientSpace(2);
CALL LP1.setCoefficientSpace(2);
CALL LP1.addCoefficient(-2);
CALL LP1.addCoefficient(1);
CALL  LP1.addLinearConstraint(2, v_eq, v_constraint1_value);
--
CALL LP1.solveModel();
--
