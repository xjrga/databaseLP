SET SCHEMA LP1;
/
CREATE PROCEDURE testProblem05 (
)
...
DECLARE v_eq INT;
--
DECLARE solutionPointValueAt CURSOR FOR SELECT LP1.getSolutionPointValueAt(i) as SolutionPoint FROM (SELECT rownum()-1 as i FROM INFORMATION_SCHEMA.Columns) WHERE i < 3;
...
DECLARE LhsByVariable CURSOR FOR SELECT LP1.getLhsByVariable(i) as ConstraintColumn FROM (SELECT rownum()-1 as i FROM INFORMATION_SCHEMA.Columns) WHERE i < 3;
DECLARE LhsValueAt CURSOR FOR SELECT LP1.getLhsValueAt(y,x) as ConstraintElementValue FROM (SELECT x, y FROM (SELECT rownum() -1 AS x FROM INFORMATION_SCHEMA.Columns WHERE rownum() -1 < 3) a, (SELECT rownum() -1 AS y FROM INFORMATION_SCHEMA.Columns WHERE rownum() -1 < 3) b);
...
--
CALL LP1.setNumberOfVariables(3);
CALL LP1.setNumberOfConstraints(3);
--
CALL LP1.addCoefficientSpace(0);
CALL LP1.setCoefficientSpace(0);
CALL LP1.addCoefficient(12);
CALL LP1.addCoefficient(3);
CALL LP1.addCoefficient(1);
CALL LP1.addLinearObjectiveFunction(0);
--
CALL LP1.addCoefficientSpace(1);
CALL LP1.setCoefficientSpace(1);
CALL LP1.addCoefficient(10);
CALL LP1.addCoefficient(2);
CALL LP1.addCoefficient(1);
CALL  LP1.addLinearConstraint(1,2,100);
--
CALL LP1.addCoefficientSpace(2);
CALL LP1.setCoefficientSpace(2);
CALL LP1.addCoefficient(7);
CALL LP1.addCoefficient(3);
CALL LP1.addCoefficient(2);
CALL  LP1.addLinearConstraint(2,2,77);
--
...
CALL LP1.addCoefficient(1);
CALL  LP1.addLinearConstraint(3,2,80);
--
CALL LP1.solveModel();
--
